...
################หน้าต่างบันทึกshortnote###################
def shortnotes(ep):
	with open('shortnote.csv','a',newline='',encoding='utf-8') as file:
		fw = csv.writer(file) 
		fw.writerow(ep) 
	print('Done!')
...
def gui2():
	...
	l=Label(GUI2,text='คุณสามารถบันทึกshortnoteเก็บไว้ได้นะ',font=FONT)
	l.pack()
	...
	b = ttk.Button(GUI2,text='บันทึก',command=save)
	b.pack(pady=20)

	l1=Label(GUI2,text='คุณสามารถดูบันทึก shortnote ของคุณได้ที่ไฟล์\nshortnote.csv',font=FONT)
	l1.pack()
